...
- Router supports repeatable parameters (`:name+`, `:name*`).

## [0.23.0] - 2026-03-28

### Added

- Media type detection fallbacks to content detection if detection by extension fails.

### Changed

- Go 1.25 or newer is required.
- `GetMetrics` returns dummy value if metrics are not available in the context.
...
- Change short CLI flag for development from `-d` to `-D`.
...
- Remove `TLS.Domain` field and CLI flag.
...
[unreleased]: https://gitlab.com/tozd/waf/-/compare/v0.24.0...main
[0.24.0]: https://gitlab.com/tozd/waf/-/compare/v0.23.0...v0.24.0
[0.23.0]: https://gitlab.com/tozd/waf/-/compare/v0.22.0...v0.23.0
