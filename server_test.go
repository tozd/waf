...
func TestServer(t *testing.T) {
	...
	assert.ElementsMatch(
		...
		[]string{
			...
			`{"level":"info","method":"GET","path":"/test.html","client":"127.0.0.1","agent":"Go-http-client/1.1","request":"","proto":"1.1","host":"example.com","code":308,"responseBody":71,"requestBody":0,"metrics":{"t":},"message":"RedirectHTTP"}`,
			`{"level":"info","method":"GET","path":"/test.html","client":"127.0.0.1","agent":"Go-http-client/1.1","request":"","proto":"1.1","host":"localhost","code":308,"responseBody":69,"requestBody":0,"metrics":{"t":},"message":"RedirectHTTP"}`,
			`{"level":"warn","method":"GET","path":"/","client":"127.0.0.1","agent":"Go-http-client/1.1","request":"","proto":"1.1","host":"something.com","error":"host not found in domains","code":404,"responseBody":10,"requestBody":0,"metrics":{"t":},"message":"RedirectHTTP"}`,
