...
func TestServer(t *testing.T) {
	...
	assert.ElementsMatch(
		...
		[]string{
			...
			`{"level":"warn","method":"GET","path":"/","client":"127.0.0.1","agent":"Go-http-client/1.1","request":"","proto":"1.1","host":"something.com","error":"host not found in domains","code":404,"responseBody":10,"requestBody":0,"metrics":{"t":},"message":"HTTP2HTTPSRedirect"}`,
