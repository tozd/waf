...
func TestParsePath(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			inputPath: "/:chapters+",
			expectedResult: []pathSegment{
				{Value: "chapters", Parameter: true, Repeatable: true, Optional: false},
			},
			expectedError: "",
		},
		{
			inputPath: "/:chapters*",
			expectedResult: []pathSegment{
				{Value: "chapters", Parameter: true, Repeatable: true, Optional: true},
			},
			expectedError: "",
		},
		{
			inputPath: "/debug/jobs/:path*",
			expectedResult: []pathSegment{
				{Value: "debug", Parameter: false},
				{Value: "jobs", Parameter: false},
				{Value: "path", Parameter: true, Repeatable: true, Optional: true},
			},
			expectedError: "",
		},
		{
			inputPath:      "/:chapters+/more",
			expectedResult: nil,
			expectedError:  "repeatable parameter must be the last segment",
		},
		{
			inputPath:      "/:+",
			expectedResult: nil,
...
func TestCompileRegexp(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectedRegexp: `^/debug/jobs(?:/(.*))?$`,
			inputMatch:     []string{"/debug/jobs/api/jobs", "api/jobs"},
			expectedParams: Params{
				"path": "api/jobs",
			},
			expectedError: "",
		...
		{
			inputSegments: []pathSegment{
				{Value: "files", Parameter: false},
				{Value: "rest", Parameter: true, Repeatable: true, Optional: false},
			},
			expectedRegexp: `^/files/(.+)$`,
			inputMatch:     []string{"/files/a/b/c", "a/b/c"},
			expectedParams: Params{
				"rest": "a/b/c",
			},
			expectedError: "",
...
func TestRouterReverse(t *testing.T) {
	...
	tests := []struct {
		...
		{
			description:   "Required repeatable parameter with multiple segments",
			path:          "/files/:rest+",
			api:           false,
			params:        Params{"rest": "a/b/c"},
			qs:            url.Values{},
			inputAPI:      false,
			encodeQuery:   nil,
			expectedPath:  "/files/a/b/c",
			expectedError: "",
		},
		{
			description:   "Required repeatable parameter with a single segment",
			path:          "/files/:rest+",
			api:           false,
			params:        Params{"rest": "only"},
			qs:            url.Values{},
			inputAPI:      false,
			encodeQuery:   nil,
			expectedPath:  "/files/only",
			expectedError: "",
		},
		{
			description:   "Required repeatable parameter is missing",
			path:          "/files/:rest+",
			api:           false,
			params:        Params{},
			qs:            url.Values{},
		...
		{
			description:   "Required repeatable parameter is empty",
			path:          "/files/:rest+",
			api:           false,
			params:        Params{"rest": ""},
			qs:            url.Values{},
		...
		{
			description:   "Optional repeatable parameter with multiple segments",
			path:          "/debug/jobs/:path*",
			api:           false,
			params:        Params{"path": "api/jobs/123"},
			qs:            url.Values{},
			inputAPI:      false,
			encodeQuery:   nil,
			expectedPath:  "/debug/jobs/api/jobs/123",
			expectedError: "",
		},
		{
			description:   "Optional repeatable parameter with value starting with slash",
			path:          "/debug/jobs/:path*",
			api:           false,
			params:        Params{"path": "/api/jobs"},
			qs:            url.Values{},
			inputAPI:      false,
			encodeQuery:   nil,
			expectedPath:  "/debug/jobs/api/jobs",
			expectedError: "",
		},
		{
			description:   "Optional repeatable parameter is omitted",
			path:          "/debug/jobs/:path*",
			api:           false,
			params:        Params{},
			qs:            url.Values{},
			inputAPI:      false,
			encodeQuery:   nil,
			expectedPath:  "/debug/jobs",
			expectedError: "",
		},
		{
			description:   "Optional repeatable parameter is empty",
			path:          "/debug/jobs/:path*",
			api:           false,
			params:        Params{"path": ""},
			qs:            url.Values{},
		...
		{
			description:   "API path with repeatable parameter and query string",
			path:          "/debug/jobs/:path*",
			api:           true,
			params:        Params{"path": "api/jobs"},
			qs:            url.Values{"state": {"available"}},
			inputAPI:      true,
			encodeQuery:   nil,
			expectedPath:  "/api/debug/jobs/api/jobs?state=available",
			expectedError: "",
		},
		{
			description:   "Repeatable parameter with extra parameters",
			path:          "/files/:rest+",
			api:           false,
			params:        Params{"rest": "a/b", "extra": "foobar"},
			qs:            url.Values{},
			inputAPI:      false,
			encodeQuery:   nil,
			expectedPath:  "",
